...
export function AssignSalesmanDialog({
  ...
  // Filter out salesmen who are already assigned to other orders
  const availableSalesmen = mockSalesmen.filter(
    salesman => !assignedSalesmen.includes(salesman.name) || salesman.name === currentSalesman
  );
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px] bg-card border-border/50 shadow-xl">
        <DialogHeader>
