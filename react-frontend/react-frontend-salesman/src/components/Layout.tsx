...
import LogoutAccountBar from "@/components/LogoutAccountBar";
import { Link, useLocation } from "react-router-dom";
import { Menu, X, Zap, ShoppingCart, ClipboardList, User, Sun, Moon } from "lucide-react";
...
const Layout = ({ children }: LayoutProps) => {
  ...
  // Render LogoutAccountBar except on /profile
  const showLogoutBar = location.pathname !== "/profile";

  return (
    <div className="min-h-screen flex w-full bg-background">
      {showLogoutBar && <div className="absolute top-0 right-0 z-50"> <LogoutAccountBar /></div>}
      {/* Mobile Header */}
